...
public class DirectAdapter extends SinglePicVehicleAdapter {

  public DirectAdapter(Context context, List<HCVehicleItemEntity> data, int layoutid) {
      ...
      if (innerView != null) {
        innerView.setOnClickListener(new View.OnClickListener() {
          @Override public void onClick(View v) {
            ...
            VehicleDetailActivity.idToThis(GlobalData.mContext, curId, "直营店");
          }
        });
      }
    }
